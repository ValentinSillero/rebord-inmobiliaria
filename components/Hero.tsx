...
import { propertyFilterOptions, propertyFilterRecords } from '@/data/properties';
...
export function Hero() {
  return <section className="hero">
    ...
    <div className="container hero-content">
      ...
      <PropertySearch options={propertyFilterOptions} facetRecords={propertyFilterRecords} />
    </div>
  </section>;
}
